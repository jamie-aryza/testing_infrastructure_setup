# Post-install configuration for the Live SQL Server role.
# Generated/updated by Inventory-SqlServer.ps1 -Environment Live.
...
@{
    ...
    # Updated automatically when Inventory-SqlServer.ps1 is run with -Environment Live.
    BaselinePath = 'infrastructure-baseline\localhost_LIVE'
    ...
    # Pipeline SQL login created on the live SQL Server.
    ...
    LinkedServerName                  = 'SQL-TEST'
    LinkedServerLogin                 = 'ls_remote_query'
    LinkedServerRemoteTerraformOutput = 'sql_test_public_ip'
}
